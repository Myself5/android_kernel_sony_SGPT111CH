...
#if !defined(NBX_WORKAROUND_DVFS_AP20H_VOLTABLE)
...
#endif /* !NBX_WORKAROUND_DVFS_AP20H_VOLTABLE */

#if defined(NBX_WORKAROUND_DVFS_AP20H_VOLTABLE)
static const int core_millivolts[MAX_DVFS_FREQS] =
	{1000, 1000, 1100, 1200, 1200, 1200, 1200};
static const int cpu_millivolts[MAX_DVFS_FREQS] =
	{750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1050, 1050};
