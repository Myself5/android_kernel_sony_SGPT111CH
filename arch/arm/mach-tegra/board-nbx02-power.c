...
static struct regulator_consumer_supply tps658621_ldo0_supply[] = {
	...
	REGULATOR_SUPPLY("vcsi", "tegra_camera"), // AVDD_DSI_CSI
};
...
static struct regulator_consumer_supply tps658621_ldo4_supply[] = {
	...
	REGULATOR_SUPPLY("vdd_fuse", NULL),  // dummy
	REGULATOR_SUPPLY("avdd_usb", NULL),  // dummy
	REGULATOR_SUPPLY("vmmc", "sdhci-tegra.0"),  // dummy
	REGULATOR_SUPPLY("vmmc", "sdhci-tegra.2"),  // dummy
};
...
static struct regulator_consumer_supply tps658621_ldo9_supply[] = {
	...
	//REGULATOR_SUPPLY("avdd_amp", NULL),  // speaker amp?
};
static struct regulator_consumer_supply tps658621_ldortc_supply[] = {
	REGULATOR_SUPPLY("vdd_ldortc", NULL),
	//REGULATOR_SUPPLY("vcoin", NULL),
};
...
static struct regulator_init_data sm2_data = REGULATOR_INIT(sm2, 3000, 4550, OFF, NULL); /* not used */
static struct regulator_init_data ldo0_data = REGULATOR_INIT(ldo0, 1200, 1200, ON, NULL);
static struct regulator_init_data ldo1_data = REGULATOR_INIT(ldo1, 1100, 1100, ON, NULL);
static struct regulator_init_data ldo2_data = REGULATOR_INIT(ldo2, 1000, 1200, ON, NULL); /* VDD_RTC */
...
static struct i2c_board_info __initdata nbx02_regulators[] = {
	{
...
static struct tegra_suspend_platform_data nbx02_suspend_data = {
	/*
...
int __init nbx02_regulator_init(void)
{
	...
	if (minor == 3 && !(tegra_spare_fuse(18) || tegra_spare_fuse(19)))
		nbx02_suspend_data.suspend_mode = TEGRA_SUSPEND_LP1;
	...
	i2c_register_board_info(3, nbx02_regulators, 1);

	/* FIXME: adjust all always_on parameters before comment-in */
        //regulator_has_full_constraints();

	tegra_init_suspend(&nbx02_suspend_data);
