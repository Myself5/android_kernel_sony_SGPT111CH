...
static const struct tegra_emc_table nbx03_emc_tables_elpida_1024[] = {
	{
...
static const struct tegra_emc_table nbx03_emc_tables_hynix_1024[] = {
	{
		.rate = 25000,   /* SDRAM frquency */
		.regs = {
			0x00000002,   /* RC */
...
static const struct tegra_emc_chip nbx03_emc_chips_elpida_1024[] = {
	{
		...
		.mem_revision_id2 = -1,
		.mem_pid = -1,
		.table = nbx03_emc_tables_elpida_1024,
		.table_size = ARRAY_SIZE(nbx03_emc_tables_elpida_1024)
	},
};

static const struct tegra_emc_chip nbx03_emc_chips_hynix_1024[] = {
	{
		...
		.mem_revision_id2 = -1,
		.mem_pid = -1,
		.table = nbx03_emc_tables_hynix_1024,
		.table_size = ARRAY_SIZE(nbx03_emc_tables_hynix_1024)
	},
};
...
int nbx03_emc_init(void)
{
	...
	if( odmdata_memtype==ODMDATA_MEMTYPE_ELPIDA_1024 ) {
		tegra_init_emc(nbx03_emc_chips_elpida_1024,
			ARRAY_SIZE(nbx03_emc_chips_elpida_1024));
	} else if( odmdata_memtype==ODMDATA_MEMTYPE_HYNIX_1024 ) {
		tegra_init_emc(nbx03_emc_chips_hynix_1024,
			ARRAY_SIZE(nbx03_emc_chips_hynix_1024));
	} else {
		/* do nothing */
	}
